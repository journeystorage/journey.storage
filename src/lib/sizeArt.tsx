...
export const SIZE_ART: SizeArtEntry[] = [
  ...
  { key: '12x12', size: "12' × 12'", label: 'Two-bedroom home', sqft: 144, accent: 'rgb(190, 130, 145)', tint: 'rgba(190,130,145,0.16)', illo: 3 },
  ...
  { key: '12x20', size: "12' × 20'", label: 'Three-bedroom home', sqft: 240, accent: 'rgb(178, 150, 96)', tint: 'rgba(178,150,96,0.16)', illo: 5 },
