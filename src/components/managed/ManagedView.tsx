...
const FACILITIES = [
  { name: 'Temple Hall Hwy', city: 'Granbury, TX', img: '/images/granbury/rs-card-temple-hall.webp', href: '/rentaspace/templehallhwy' },
  { name: 'Western Hills Trl', city: 'Granbury, TX', img: '/images/granbury/rs-card-western-hills.webp', href: '/rentaspace/westernhillstrl' },
  { name: 'McCreary Rd', city: 'Granbury, TX', img: '/images/granbury/rs-card-cleveland.webp', href: '/rentaspace/mccrearyrd' },
]
