...
Today, Lyvia drives the overarching operational strategy and structure of the ecosystem. She dictates the portfolio’s trajectory by directing capital allocation, executing on our investment thesis, structuring entity development, mentoring high-performing teams, and rigorously preserving the organization's "Empire-Building Grit." Her ability to drive financial strategy, operational discipline, and portfolio performance across complex, multi-entity structures positions her as a key driver of performance across acquisitions, development, and stabilized assets.
